...
//!
//! Any required gpubox files need to be in hyperdrive's "tests" directory.
//! These could be symlinked from somewhere else for convenience. Run these
//! "ignored" tests with something like:
//!
//! cargo test -- --ignored
...
#[serial]
#[ignore]
/// Obsid 1065880128 is an ionospherically-active MWA EoR observation. 40 kHz,
/// 0.5s. EoR-0 field. EoR high band (roughly 170-200 MHz).
///
