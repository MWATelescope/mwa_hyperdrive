...
fn test_1090008640_vis_simulate() {
    ...
    cfg_if::cfg_if! {
        if #[cfg(feature = "cuda-single")] {
            assert_abs_diff_eq!(vis[0..29], [36.239098, -37.919975, 64.0, 36.509888, -37.688175, 64.0, 0.13714215, -0.051078193, 64.0, 0.12929335, -0.07608978, 64.0, 36.183933, -37.978363, 64.0, 36.445034, -37.739532, 64.0, 0.14075089, -0.049377773, 64.0, 0.13295034, -0.07435731, 64.0, 36.12551, -38.03485, 64.0, 36.376793, -37.788895], epsilon = 5e-5);
        } else {
            assert_abs_diff_eq!(vis[0..29], [36.23898, -37.920006, 64.0, 36.50975, -37.68825, 64.0, 0.13713828, -0.05107821, 64.0, 0.12928975, -0.07608952, 64.0, 36.183853, -37.97843, 64.0, 36.44494, -37.739647, 64.0, 0.14074738, -0.049377635, 64.0, 0.13294694, -0.07435694, 64.0, 36.125416, -38.034897, 64.0, 36.37668, -37.788986], epsilon = 5e-5);
        }
    }
    ...
    cfg_if::cfg_if! {
        if #[cfg(feature = "cuda-single")] {
            assert_abs_diff_eq!(vis[0..29], [36.29235, -37.815643, 64.0, 36.566887, -37.594475, 64.0, 0.13810812, -0.051415868, 64.0, 0.1300995, -0.07634619, 64.0, 36.23478, -37.874428, 64.0, 36.499863, -37.646164, 64.0, 0.14170626, -0.049713243, 64.0, 0.13374655, -0.07461138, 64.0, 36.173973, -37.93127, 64.0, 36.42945, -37.69583], epsilon = 6e-5);
        } else {
            assert_abs_diff_eq!(vis[0..29], [36.29221, -37.81562, 64.0, 36.566708, -37.59445, 64.0, 0.13810773, -0.0514111, 64.0, 0.13010167, -0.07633954, 64.0, 36.234665, -37.87441, 64.0, 36.499706, -37.646156, 64.0, 0.14170499, -0.049708802, 64.0, 0.13374788, -0.07460498, 64.0, 36.173786, -37.931236, 64.0, 36.42923, -37.6958], epsilon = 5e-5);
        }
    }
    for (i, vis) in vis.iter().enumerate() {
        if i % 3 == 2 {
