...
int rotate_average(const JONES *d_high_res_vis, const float *d_high_res_weights, JONES *d_low_res_vis,
...
int iono_loop(const JONES *d_vis_residual, const float *d_vis_weights, const JonesF32 *d_vis_model,
...
int subtract_iono(JONES *d_vis_residual, const JonesF32 *d_vis_model, double iono_const_alpha, double iono_const_beta,
