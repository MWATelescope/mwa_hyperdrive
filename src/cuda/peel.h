...
int rotate_average(const JONES *d_high_res_vis, const FLOAT *d_high_res_weights, JONES *d_low_res_vis,
                   const FLOAT *d_low_res_weights, RADec pointing_centre, const int num_timesteps, const int num_tiles,
                   const int num_baselines, const int num_freqs, const int freq_average_factor, const FLOAT *d_lmsts,
