...
fn bindgen_test_layout_Addresses() {
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).sbf_l) as usize - ptr as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(Addresses),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).sbf_n) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(Addresses),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).sbf_c) as usize - ptr as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(Addresses),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).sbf_dx) as usize - ptr as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(Addresses),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).d_vis) as usize - ptr as usize },
        88usize,
        concat!(
            "Offset of field: ",
            stringify!(Addresses),
...
pub struct Points {
    ...
    pub curved_power_law_fds: *const JonesF64,
    pub curved_power_law_sis: *const f64,
    pub curved_power_law_qs: *const f64,
